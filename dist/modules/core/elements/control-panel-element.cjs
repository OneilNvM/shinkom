...
const require_control_panel_templates = require("./templates/control-panel.templates.cjs");
...
var CompatControlPanelElement = class extends BaseElement {
	constructor() {
		...
		cachedStyleSheet = require_helpers.getStyleSheet(cachedStyleSheet, require_control_panel_templates.controlPanelStyles);
		cachedTransitions = require_helpers.getStyleSheet(cachedTransitions, require_control_panel_templates.controlPanelTransitions);
	}
	connectedCallback() {
	...
	*/
	render(tab = void 0) {
		this.shadowHost.innerHTML = require_control_panel_templates.controlPanelHTML;
	...
	*/
	renderTabContent(tab) {
		...
		switch (tab) {
			case "inspector":
				if (main) main.innerHTML = require_control_panel_templates.controlPanelInspectorTab;
				break;
			case "compatView":
				if (main) main.innerHTML = require_control_panel_templates.controlPanelCompatViewTab;
				break;
			default: break;
		}
	}
...
//#endregion
exports.CompatControlPanelElement = CompatControlPanelElement;
