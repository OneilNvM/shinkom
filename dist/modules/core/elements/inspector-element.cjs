...
//#region src/core/elements/inspector-element.js
/**
...
* @extends {BaseElement}
*/
var CompatInspectorElement = class extends BaseElement {
	constructor() {
		super();
		/**@type {ShadowRoot} */
...
//#endregion
exports.CompatInspectorElement = CompatInspectorElement;
