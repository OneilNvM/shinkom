...
const require_recent_result_item = require("../../core/elements/recent-result-item.cjs");
const require_results_history_item = require("../../core/elements/results-history-item.cjs");
...
* @extends {UIComponent}
*/
var CompatView = class CompatView extends require_core_ui_component.UIComponent {
	...
	*/
	static register() {
		if (typeof window !== "undefined" && "customElements" in globalThis) {
			if (!globalThis.customElements.get("sk-compat-view")) globalThis.customElements.define("sk-compat-view", require_core_elements_compat_view_element.CompatViewElement);
			if (!globalThis.customElements.get("sk-recent-result-item")) globalThis.customElements.define("sk-recent-result-item", require_recent_result_item.RecentResultItem);
			if (!globalThis.customElements.get("sk-history-item")) globalThis.customElements.define("sk-history-item", require_results_history_item.ResultsHistoryItem);
		}
	}
	/**
