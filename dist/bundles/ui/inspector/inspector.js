...
* @extends {UIComponent}
*/
var CompatInspector = class CompatInspector extends UIComponent {
	...
	*/
	static register() {
		if ("customElements" in globalThis && !globalThis.customElements.get("sk-compat-inspector")) globalThis.customElements.define("sk-compat-inspector", CompatInspectorElement);
	}
	/**
