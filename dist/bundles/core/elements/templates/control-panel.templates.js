/**
    * Shinkom - core\elements\templates\control-panel
    * @version 1.1.0
    * @license MIT
...
`;
//#endregion
export { controlPanelCompatViewTab, controlPanelHTML, controlPanelInspectorTab, controlPanelStyles, controlPanelTransitions };
